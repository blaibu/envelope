@Envelope.module "Entities", (Entities, App, Backbone, Marionette, $, _) ->
	...
	API =
		getFormButtons: (buttons, model) ->
			...
			array = []
			array.push { type: "cancel", className: "btn btn-default " + buttons.size, text: buttons.cancel } unless buttons.cancel is false
			array.push { type: "primary", className: "btn btn-primary " + buttons.size, text: buttons.primary, buttonType: "submit" } unless buttons.primary is false
